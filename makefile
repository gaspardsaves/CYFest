all: execdef
interface.o: interface.c interface.h smartrobusnest.h structures.h color.h manager.h festivalgoers.h backupfile.h
...
execdef: interface.o manager.o festivalgoers.o smartrobusnest.o backupfile.o
	gcc interface.o manager.o festivalgoers.o smartrobusnest.o backupfile.o -o execdef

clean:
	rm interface.o manager.o festivalgoers.o smartrobusnest.o backupfile.o
	rm execdef